...
const zhaominExtra = [
  // --- 第十一拍：玄冥寒掌 ---
  {
    ...
    question: {
      ...
      correctIndex: 1,
      explanation: '妇科疾病中寒热辨证至关重要，治法截然相反。寒证痛经（宫寒型）：小腹冷痛、得热则减、经色暗有块、畏寒肢冷，治以温经散寒；热证痛经（湿热/郁热型）：小腹灼痛、经色深红质稠、口干舌红，治以清热凉血。若寒热不分，如宫寒者误用寒凉药则雪上加霜。现代医学认为原发性痛经常与前列腺素升高、子宫收缩和缺血相关；继发性痛经需警惕子宫内膜异位症、盆腔炎等。热疗对原发性痛经有一定缓痛证据；艾灸、针刺等中医外治应辨证使用，并由专业人员指导。',
      references: [
        "[1] 佚名. 黄帝内经·素问·至真要大论[M/OL]. 中国哲学书电子化计划, [2026-06-18]. https://ctext.org/huangdi-neijing/zhi-zhen-yao-da-lun/zh.",
        "[2] Kirsch E, Rahman S, Kerolus K, et al. Dysmenorrhea, a narrative review of therapeutic options[J]. Journal of Pain Research, 2024, 17: 2657-2666. DOI: 10.2147/JPR.S459584.",
        "[3] Yuan D, Liu Y, Chen Z, et al. Heat therapy for primary dysmenorrhea: a systematic review and meta-analysis[J]. Frontiers in Medicine, 2026, 12: 1730505. DOI: 10.3389/fmed.2025.1730505.",
        "[4] 傅山. 傅青主女科: 经水将来脐下先疼痛[M/OL]. 维基文库, [2026-06-18]. https://zh.wikisource.org/zh-hans/傅青主女科.",
      ],
    },
  },
  ...
  // --- 第十二拍：大都宫闱 ---
  {
    ...
    question: {
      ...
      correctIndex: 2,
      explanation: '"天然"不等于安全。乌头类可诱发恶性心律失常，马钱子中的士的宁可致惊厥，朱砂和雄黄涉及汞、砷暴露风险；这些药材均有严格的炮制、剂量、疗程和适应证要求。安全用药要看具体品种、来源、炮制、配伍、剂量、基础疾病和合并用药，不能笼统宣称某一中成药"常规剂量下都安全"。即使是常见中成药，也可能有禁忌、不良反应或药物相互作用，应按说明书并在医师或药师指导下使用。',
      references: [
        "[1] 佚名. 神农本草经[M/OL]. 中医笈成, [2026-06-18]. https://jicheng.tw/tcm/book/神農本草經_2/index.html.",
        "[2] 国家药品监督管理局, 国家卫生健康委员会. 关于颁布2025年版《中华人民共和国药典》的公告(2025年第29号)[EB/OL]. 2025-03-25[2026-06-18]. https://www.nmpa.gov.cn/xxgk/fgwj/gzwj/gzwjyp/20250325183810122.html.",
        "[3] Zhou C, Luo S, Tang J, et al. Poisoning associated with consumption of a homemade medicinal liquor - Chongqing, China, 2018[J]. MMWR. Morbidity and Mortality Weekly Report, 2022, 71(16): 569-573. DOI: 10.15585/mmwr.mm7116a2.",
        "[4] Lawson C, McCabe D J, Feldman R. A narrative review of aconite poisoning and management[J]. Journal of Intensive Care Medicine, 2025, 40(8): 811-817. DOI: 10.1177/08850666241245703.",
      ],
    },
  },
  ...
  // --- 第十三拍：蝴蝶谷中 ---
  {
    ...
    dialogues: [
      ...
      { speaker: '张无忌', text: '胡师教我，望诊可察面色与舌象，但须四诊合参。唇甲苍白、面色异常或舌象变化，只能算线索，不能凭一眼便断病；若伴头晕、气促、发热或持续不适，还须验血与求医。望而知之虽称神，妄下断语却非医道。', frameIdx: 2 },
    ],
    question: {
      type: 'short_answer',
      ...
      chatOpening: '蝴蝶谷中，百花盛开。面色者，传统医家视为气血之华；然而灯色、肤色、睡眠与妆容皆会影响所见，断不可望一眼便定病。汝若愿意，可说说近日面色变化是否持续，又伴有头晕、乏力、潮热或其他不适？',
      explanation: '望诊具有直观、无创的特点，但面色和舌象受光线、肤色、饮食、药物、口腔卫生等多种因素影响，不能单独用于自我诊断。苍白伴乏力、气促可能提示贫血等问题，应查血常规；突然发绀、意识异常或呼吸困难属于急症信号。中医会把面色、舌象作为辨证线索之一，仍须与闻、问、切合参；现代诊断则需结合病史、体格检查和必要的实验室/影像检查。游戏鼓励观察身体变化，但不鼓励按舌色或脸色自行开药。',
      references: [
        "[1] 中国哲学书电子化计划. 难经·六十一难[EB/OL]. https://ctext.org/nan-jing/shen-sheng-gong-qiao/zh.",
        "[2] 中国哲学书电子化计划. 黄帝内经·素问·金匮真言论[EB/OL]. https://ctext.org/huangdi-neijing/jin-gui-zhen-yan-lun/zhs.",
        "[3] Matos L C, Machado J P, Monteiro F J, Greten H J. Can traditional Chinese medicine diagnosis be parameterized and standardized? a narrative review[J]. Healthcare (Basel), 2021, 9(2):177. PMID:33562368. PMCID:PMC7914658.",
        "[4] Feng L, Xiao W, Wen C, Deng Q. Objectification of tongue diagnosis in traditional medicine, data analysis, and study application[J]. Journal of Visualized Experiments, 2023, (194):e65140. DOI:10.3791/65140.",
      ],
    },
  },
  ...
  // --- 第十四拍：光明顶上 ---
  {
    ...
    question: {
      ...
      correctIndex: 1,
      explanation: '盆底肌训练是女性尿失禁等盆底功能障碍的一线保守治疗之一，但关键在于正确识别、收缩并充分放松盆底肌；有疼痛、排尿困难或盆底过度紧张者宜先接受专业评估。月经本身不是停止运动的理由，可根据疼痛、出血量和个人感受调整强度。运动应循序渐进；长期能量摄入不足与过量训练可造成相对能量缺乏和功能性下丘脑性闭经。适当抗阻训练有助于肌力与骨骼健康，八段锦、太极拳等也可作为低至中等强度活动选择。',
      references: [
        "[1] Woodley S J, Boyle R, Cody J D, et al. Pelvic floor muscle training for urinary incontinence in women[J]. Cochrane Database of Systematic Reviews, 2024, 12:CD009508. PMID:39704322.",
        "[2] American College of Obstetricians and Gynecologists. Urinary incontinence: Kegel exercises[EB/OL]. https://www.acog.org/womens-health/faqs/urinary-incontinence.",
        "[3] National Institute for Health and Care Excellence. Urinary incontinence and pelvic organ prolapse in women: management (NG123)[S]. 2019 (updated). https://www.nice.org.uk/guidance/ng123.",
        "[4] Mountjoy M, Sundgot-Borgen J, Burke L, et al. 2023 international Olympic Committee consensus statement on relative energy deficiency in sport (REDs)[J]. British Journal of Sports Medicine, 2023, 57(17):1073–1098. DOI:10.1136/bjsports-2023-106994.",
      ],
    },
  },
  ...
  // --- 第十五拍：波斯异术 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] 国家药品监督管理局, 国家卫生健康委员会. 关于颁布2025年版《中华人民共和国药典》的公告（2025年第29号）[S]. 2025-03-20. https://www.nmpa.gov.cn/xxgk/fgwj/gzwj/gzwjyp/20250325183810122.html.",
        "[2] Mohammadi M M, Karimi Z. Effect of saffron on premenstrual syndrome and dysmenorrhea: a systematic review and meta-analysis[J]. Korean Journal of Family Medicine, 2026, 47(1):69–80. DOI:10.4082/kjfm.24.0259.",
        "[3] Hasheminasab F S, Azimi M, Raeiszadeh M, et al. Therapeutic effects of saffron (Crocus sativus L.) on female reproductive system disorders: a systematic review[J]. Phytotherapy Research, 2024. PMID:38558480.",
        "[4] 卫生福利部国家中医药研究所. 番红花与红花[EB/OL]. https://www.nricm.edu.tw/p/404-1000-5146.php?Lang=zh-tw.",
      ],
    },
  },
  ...
  // --- 第十六拍：襄阳遗梦 ---
  {
    ...
    question: {
      ...
      correctIndex: 0,
      explanation: '鼻出血时应坐直、身体略前倾，用拇指和食指持续捏紧鼻翼柔软处10-15分钟并用口呼吸；不要仰头，也不要反复松手查看或把纸团深塞入鼻腔。若持续压迫后仍大量出血、因外伤引起、伴头晕乏力，或正在使用抗凝药，应及时就医。成人心肺复苏胸外按压通常为每分钟100-120次、深度至少5厘米并避免超过6厘米；气道异物处理应按患者年龄、是否清醒及能否有效咳嗽选择拍背、腹部冲击或胸部冲击。',
      references: [
        "[1] Panchal A R, Bartos J A, Cabanas J G, et al. 2024 American Heart Association and American Red Cross guidelines for first aid[J]. Circulation, 2024. DOI:10.1161/CIR.0000000000001281.",
        "[2] American Heart Association. 2025 American Heart Association guidelines for CPR and emergency cardiovascular care[J]. Circulation, 2025, 152(suppl 2). DOI:10.1161/CIR.0000000000001372.",
        "[3] Mayo Clinic Staff. Nosebleeds: first aid[EB/OL]. https://www.mayoclinic.org/first-aid/first-aid-nosebleeds/basics/art-20056683.",
        "[4] American Red Cross. Nosebleed first aid guidelines[EB/OL]. https://www.redcross.org/take-a-class/resources/guidelines.",
      ],
    },
  },
  ...
  // --- 第十七拍：终南问道 ---
  {
    ...
    dialogues: [
      ...
      { speaker: '隐士', text: '郡主好问。古人谈"养阴血、疏肝气、固肾精"，落到日用，不过是饮食有节、起居有常、劳逸相济、情志有托。药膳与针灸皆有适应证和禁忌，不可见方就补、见穴就灸；若月事异常、久痛不愈，仍当求医。', frameIdx: 2 },
    ],
    question: {
      type: 'short_answer',
      ...
      explanation: '把中医养生智慧融入现代生活，宜从低风险、可持续的习惯开始：规律睡眠，均衡饮食，避免过度节食，进行每周规律的有氧与抗阻活动，保留稳定的社会支持，并按年龄和风险接受疫苗、筛查与慢病管理。红枣、阿胶、黑芝麻等食物或药材不能笼统称为"补血"，贫血须查血常规和铁蛋白；中药、艾灸和穴位刺激也有禁忌，应由合格专业人员评估。持续月经异常、剧烈疼痛、异常出血或明显情绪问题，不应只靠"养生"拖延就医。',
      references: [
        "[1] 中国哲学书电子化计划. 黄帝内经·素问·上古天真论[EB/OL]. https://ctext.org/huangdi-neijing/shang-gu-tian-zhen-lun/zhs.",
        "[2] National Center for Complementary and Integrative Health. Yoga for health: what the science says[EB/OL]. 2024. https://www.nccih.nih.gov/health/providers/digest/yoga-for-health-science.",
        "[3] National Center for Complementary and Integrative Health. Sleep disorders and complementary health approaches[EB/OL]. https://www.nccih.nih.gov/health/sleep-disorders-and-complementary-health-approaches.",
        "[4] Li X, Wang C, et al. Qigong and tai chi on human health: an overview of systematic reviews[J]. American Journal of Chinese Medicine, 2022. PMID:36266755.",
      ],
    },
  },
  ...
  // --- 第十八拍：天下归心 ---
  {
    ...
    question: {
      ...
      correctIndex: 1,
      explanation: '世界卫生组织（WHO）强调以全生命周期（life-course approach）理解健康：青春期、育龄期、围绝经期与老年期彼此相连，不应只在生病或备孕时才关注身体。各阶段重点包括：青春期的月经与营养教育、按国家免疫程序接种HPV疫苗；育龄期的避孕或孕前保健，以及按年龄与风险开展宫颈癌和乳腺癌筛查；围绝经期的症状管理、心血管和骨折风险评估；老年期的防跌倒、认知、盆底与慢病管理。具体筛查起始年龄和间隔须遵循所在地最新指南与个人风险，不能用一套固定检查覆盖所有女性。中医"治未病"思想可与现代预防医学对话，但预防仍须建立在疫苗、筛查、生活方式和规范诊疗之上。',
      references: [
        "[1] World Health Organization. Global strategy for women’s, children’s and adolescents’ health (2016–2030)［EB/OL］. https://platform.who.int/data/maternal-newborn-child-adolescent-ageing/global-strategy-data.",
        "[2] World Health Organization. Women’s health［EB/OL］. https://www.who.int/health-topics/women-s-health.",
        "[3] Pan American Health Organization. Healthy life course［EB/OL］. https://www.paho.org/en/topics/healthy-life-course.",
        "[4] 国务院. 中国妇女发展纲要（2021—2030年）［Z］. 国发〔2021〕16号［EB/OL］. 2021-09-08. https://www.mee.gov.cn/zcwj/gwywj/202109/t20210927_954260.shtml.",
        "[5] 佚名. 黄帝内经·素问·四气调神大论［M］. 北京：中国哲学书电子化计划（CTEXT）数据库［EB/OL］. https://ctext.org/huangdi-neijing/si-qi-diao-shen-da-lun/zh.",
      ],
    },
  },
];
...
const zhouzhiruoExtra = [
  // --- 第七拍：九阴白骨 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] Di Matteo A, Bathon J M, Emery P. Rheumatoid arthritis［J］. The Lancet, 2023, 402(10416): 2019-2033. DOI:10.1016/S0140-6736(23)01525-8.",
        "[2] Hunter D J, Bierma-Zeinstra S. Osteoarthritis［J］. The Lancet, 2019, 393(10182): 1745-1759. DOI:10.1016/S0140-6736(19)30417-9.",
        "[3] Smolen J S, Aletaha D, McInnes I B. Rheumatoid arthritis［J］. Nature Reviews Disease Primers, 2018, 4: 18001. DOI:10.1038/nrdp.2018.1.",
        "[4] 中华中医药学会骨伤科分会. 膝骨关节炎中医临床诊疗指南［J］. 康复学报, 2019, 29(3): 1-7.",
      ],
    },
  },
  ...
  // --- 第八拍：峨眉掌门 ---
  {
    ...
    question: {
      ...
      correctIndex: 1,
      explanation: '职业女性健康管理应避免"一张体检套餐包打天下"：宫颈癌、乳腺癌、血压、血脂、血糖等筛查应按年龄、既往结果和个人风险安排，甲状腺或盆腔超声并非所有无症状女性每年必做。多数成人需要规律而充足的睡眠、每周至少150分钟中等强度活动并配合肌力训练；轮班工作造成的昼夜节律紊乱被IARC列为"很可能对人类致癌"，更应重视排班、睡眠与职业健康保护。稳定的社会支持、合理边界和及时求助同样重要；中药调理需辨证，不能替代循证筛查和心理支持。',
      references: [
        "[1] International Agency for Research on Cancer. IARC monographs on the identification of carcinogenic hazards to humans. Volume 124: Night shift work［M］. Lyon: IARC, 2020. Available at: https://publications.iarc.who.int/Book-And-Report-Series/Iarc-Monographs-On-The-Identification-Of-Carcinogenic-Hazards-To-Humans/Night-Shift-Work-2020.",
        "[2] Shanafelt T D, West C P, Dyrbye L N, et al. Changes in burnout and satisfaction with work-life integration in physicians during the first 2 years of the COVID-19 pandemic［J］. Mayo Clinic Proceedings, 2022, 97(12): 2248-2258. DOI:10.1016/j.mayocp.2022.09.002.",
        "[3] World Health Organization. Burn-out an occupational phenomenon: ICD-11［EB/OL］. https://www.who.int/standards/classifications/frequently-asked-questions/burn-out-an-occupational-phenomenon.",
      ],
    },
  },
  ...
  // --- 第九拍：屠狮之会 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] 张介宾. 景岳全书［M］. 明代刻本. 电子整理本: 中国哲学书电子化计划（CTEXT）［EB/OL］. https://zh.wikisource.org/zh-hans/景岳全書_(四庫全書本)/卷18.",
        "[2] Edinger J D, Arnedt J T, Bertisch S M, et al. Behavioral and psychological treatments for chronic insomnia disorder in adults: an American Academy of Sleep Medicine clinical practice guideline［J］. Journal of Clinical Sleep Medicine, 2021, 17(2): 255-262. DOI:10.5664/jcsm.8986.",
      ],
    },
  },
  ...
  // --- 第十拍：黄衫女子 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] Erikson E H. Identity and the life cycle［M］. New York: International Universities Press, 1959. Available at: https://archive.org/details/psychologicaliss0001erik.",
        "[2] World Health Organization. Women’s health［EB/OL］. https://www.who.int/health-topics/women-s-health.",
        "[3] National Academies of Sciences, Engineering, and Medicine. Advancing research on chronic conditions in women［M］. Washington, DC: The National Academies Press, 2024. DOI:10.17226/27757.",
        "[4] 萧壎. 女科经纶［M］. 清代刻本. 电子整理本: 中国哲学书电子化计划（CTEXT）［EB/OL］. https://zh.wikisource.org/zh-hans/女科經綸/序.",
      ],
    },
  },
  ...
  // --- 第十一拍：问心有愧 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] 佚名. 金匮要略·妇人杂病脉证并治第二十二［M］. 汉代. 电子整理本: 中国哲学书电子化计划（CTEXT）［EB/OL］. https://ctext.org/jinkui-yaolue/22/zh.",
        "[2] American College of Obstetricians and Gynecologists. Screening and diagnosis of mental health conditions during pregnancy and postpartum［J］. Obstetrics & Gynecology, 2023, 141(6): 1232-1261. DOI:10.1097/AOG.0000000000005200.",
        "[3] American College of Obstetricians and Gynecologists. Treatment and management of mental health conditions during pregnancy and postpartum［J］. Obstetrics & Gynecology, 2023, 141(6): 1262-1288. DOI:10.1097/AOG.0000000000005202.",
        "[4] Howard L M, Khalifeh H. Perinatal mental health: a review of progress and challenges［J］. World Psychiatry, 2020, 19(3): 313-327. DOI:10.1002/wps.20769.",
        "[5] Stewart D E, Vigod S N. Postpartum depression［J］. New England Journal of Medicine, 2019, 380: 2187-2196. DOI:10.1056/NEJMcp1607649.",
      ],
    },
  },
  ...
  // --- 第十二拍：汉水归舟 ---
  {
    ...
    question: {
      ...
      options: [
        '坐月子期间完全不能洗头和洗澡',
        '产后可以保持清洁、尽早适度活动、均衡饮食，并按计划接受产后随访；有发热、大出血或明显情绪异常应及时就医',
        '产后抑郁是矫情的表现，不需要在意',
        '产后妈妈只需关注婴儿，不需要关注自身恢复',
      ],
      correctIndex: 1,
      explanation: '现代产后照护强调连续、主动的随访，而不是把产妇关在房中忍耐。可以洗头洗澡并保持会阴和伤口清洁；无禁忌者应尽早适度活动、均衡饮食和补充水分。产后随访应在出院后尽早建立联系，并在产后数周内完成综合评估，具体时间依当地规范和个人风险安排。持续高热、胸痛气促、单侧小腿肿痛、剧烈头痛、伤口异常、突然大量出血或自伤/伤婴念头均须紧急求助。生化汤是传统方剂，若考虑使用必须先排除产后出血、感染等急症并由中医师辨证，不能作为所有产妇的常规"排恶露"汤。',
      references: [
        "[1] 傅山. 傅青主女科［M］. 清代刻本. 电子整理本: 识典古籍［EB/OL］. https://www.shidianguji.com/book/YCM294300096/chapter/1l9ggh6dkjmer.",
        "[2] World Health Organization. WHO recommendations on maternal and newborn care for a positive postnatal experience［M］. Geneva: WHO, 2022. https://www.who.int/publications/i/item/9789240045989.",
        "[3] American College of Obstetricians and Gynecologists. Optimizing postpartum care［J］. Obstetrics & Gynecology, 2018, 131(5): e140-e150. DOI:10.1097/AOG.0000000000002633.",
      ],
    },
  },
  ...
  // --- 第十三拍：峨眉金顶 ---
  {
    ...
    question: {
      ...
      options: [
        '应优先从饮食获得足量钙和蛋白质；是否补充钙或维生素D需结合摄入、日照、化验及骨折风险',
        '只有老年人才需要关注骨质疏松，年轻人无所谓',
        '骨密度（DXA）检查应依据年龄、脆性骨折史和风险评估安排，而不是所有绝经女性每年检查',
        '负重、抗阻和平衡训练有助于维持骨量、肌力并降低跌倒风险',
      ],
      correctIndex: 1,
      explanation: '骨质疏松预防应贯穿全生命周期：青少年期建立较高峰值骨量，成年后保持营养、运动和健康体重，绝经后及老年期加强骨折风险评估和防跌倒。钙和维生素D的目标量、是否使用补充剂以及DXA检查时机，均应结合年龄、饮食、日照、既往骨折、用药和其他风险因素决定；不能要求所有人固定剂量补充，也不必让所有绝经女性每年做DXA。确诊高风险者可能需要规范抗骨质疏松药物。中医药如作为辅助，也应在专业指导下使用并监测安全性。',
      references: [
        "[1] 中华医学会骨质疏松和骨矿盐疾病分会. 原发性骨质疏松症诊疗指南（2022）［J］. 中国全科医学, 2023, 26(14): 1671-1691. DOI:10.12114/j.issn.1007-9572.2023.0121.",
        "[2] 国家卫生健康委员会. 中国居民骨质疏松症流行病学调查报告（2018）［R］. 北京: 国家卫生健康委员会, 2018. Available at: https://www.nhc.gov.cn/ewebeditor/uploadfile/2018/10/20181020192813503.pdf.",
        "[3] 佚名. 黄帝内经·素问·痿论［M］. 汉代. 电子整理本: 中国哲学书电子化计划（CTEXT）［EB/OL］. https://ctext.org/huangdi-neijing/wei-lun/zh.",
      ],
    },
  },
  ...
  // --- 第十四拍：药王谷中 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] 佚名. 太平惠民和剂局方［M］. 宋代. 电子整理本: 维基文库［EB/OL］. https://zh.wikisource.org/zh-hans/太平惠民和劑局方.",
        "[2] 卫生福利部中医药司. 四物汤说明资料［EB/OL］. https://dep.mohw.gov.tw/DOCMAP/fp-866-5530-108.html.",
        "[3] Lee S Y, et al. Therapeutic applications of Si-Wu-Tang in gynecological disorders: a pharmacological perspective［J］. Journal of Chinese Medicine, 2020, 31(1): 6-16.",
      ],
    },
  },
  ...
  // --- 第十五拍：襄阳城墙 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] World Health Organization. Breast cancer fact sheet［EB/OL］. https://www.who.int/news-room/fact-sheets/detail/breast-cancer.",
        "[2] U.S. Preventive Services Task Force. Breast cancer: screening［EB/OL］. 2024. https://www.uspreventiveservicestaskforce.org/uspstf/recommendation/breast-cancer-screening1.",
        "[3] 国家卫生健康委员会. 乳腺癌诊疗指南（2022年版）［EB/OL］. https://www.nhc.gov.cn/cms-search/downFiles/c001a73dfefc4ace889a1ea6e0230865.pdf.",
        "[4] Sung H, Ferlay J, Siegel R L, et al. Global cancer statistics 2020: GLOBOCAN estimates of incidence and mortality worldwide for 36 cancers in 185 countries［J］. CA: A Cancer Journal for Clinicians, 2021, 71: 209-249. DOI:10.3322/caac.21660.",
      ],
    },
  },
  ...
  // --- 第十六拍：终南古墓 ---
  {
    ...
    question: {
      ...
      options: [
        ...
        '中医美容也需辨证与安全评估；玉容散等传统外用方并非人人适用，使用前应注意刺激和过敏风险',
        '防晒是延缓皮肤光老化的最重要外用措施',
      ],
      correctIndex: 1,
      explanation: '非法添加汞化合物、糖皮质激素等的"速效美白"产品可能造成肾脏、神经系统或皮肤屏障损害；来源不明产品还可能存在重金属超标。更可靠的皮肤健康策略是防晒、温和清洁、按肤质保湿和治疗明确的皮肤病。防晒应结合遮阳、衣帽与足量广谱防晒产品。传统外用方和草本成分也可能刺激或致敏；四物汤、逍遥散、六味地黄丸等内服方不是美容保健品，不应自行长期服用。',
      references: [
        "[1] 国家药品监督管理局. 化妆品安全技术规范（2015年版）及相关修订通告［S/OL］. https://www.nmpa.gov.cn/.",
        "[2] World Health Organization. Radiation: protecting against skin cancer［EB/OL］. https://www.who.int/news-room/questions-and-answers/item/radiation-protecting-against-skin-cancer.",
        "[3] Krutmann J, Bouloc A, Sore G, et al. The skin aging exposome［J］. Journal of Dermatological Science, 2017, 85(3): 152-161. DOI:10.1016/j.jdermsci.2017.09.015.",
        "[4] 吴谦. 医宗金鉴·外科卷上［M］. 清代刻本. 电子整理本: 维基文库［EB/OL］. https://zh.wikisource.org/zh-hans/醫宗金鑑/外科卷上.",
        "[5] 中国中医药出版社. 中医美容学（第2版）［M］. 北京: 中国中医药出版社, 2021.",
      ],
    },
  },
  ...
  // --- 第十七拍：华山论剑 ---
  {
    ...
    question: {
      ...
      options: [
        'HPV疫苗在首次性行为前接种获益最大；超过重点接种年龄后是否接种，应依据当地免疫政策、年龄和个人情况咨询专业人员',
        '接种HPV疫苗后不需要再进行宫颈癌筛查',
        '宫颈癌筛查的起始年龄、检测方法和间隔应按所在地指南、既往结果与个人风险决定',
        '宫颈癌是可以预防和治愈的——前提是早筛查、早发现、早治疗',
      ],
      correctIndex: 1,
      explanation: '接种HPV疫苗后仍需要按指南参加宫颈癌筛查。现有疫苗可预防多数但并非全部致癌型别，也不能治疗接种前已经存在的感染；筛查则用于发现高危HPV持续感染和癌前病变。具体起始年龄、采用HPV检测还是细胞学/联合检测、间隔多久，以及何时停止筛查，均受所在地指南、免疫状态、既往结果和个人风险影响，不能统一写成所有人每3-5年一次。WHO消除宫颈癌战略以疫苗、筛查和规范治疗三条路径共同推进，三者不能互相替代。',
      references: [
        "[1] World Health Organization. Cervical cancer fact sheet[EB/OL]. 2025. https://www.who.int/news-room/fact-sheets/detail/cervical-cancer.",
        "[2] World Health Organization. Global strategy to accelerate the elimination of cervical cancer as a public health problem[S]. 2020. https://www.who.int/publications/i/item/9789240014107.",
        "[3] Centers for Disease Control and Prevention. HPV vaccine recommendations[EB/OL]. 2024. https://www.cdc.gov/hpv/hcp/vaccination-considerations/index.html.",
        "[4] Lei J, Ploner A, Elfström K M, et al. HPV vaccination and the risk of invasive cervical cancer[J]. New England Journal of Medicine, 2020, 383(14):1340–1348. DOI:10.1056/NEJMoa1917338.",
        "[5] China CDC Weekly. Accelerating cervical cancer prevention and control in China to achieve elimination strategy objectives[J]. 2022, 4(48):1067–1069. DOI:10.46234/ccdcw2022.215.",
      ],
    },
  },
  ...
  // --- 第十八拍：白莲重生 ---
  {
    ...
    question: {
      ...
      references: [
        "[1] 中国哲学书电子化计划. 黄帝内经·素问·四气调神大论[EB/OL]. https://ctext.org/huangdi-neijing/si-qi-diao-shen-da-lun/zhs.",
        "[2] World Health Organization. Women’s health[EB/OL]. https://www.who.int/health-topics/women-s-health.",
        "[3] Pan American Health Organization; World Health Organization. Healthy life course[EB/OL]. https://www.paho.org/en/topics/healthy-life-course.",
        "[4] 中华人民共和国国务院. “健康中国2030”规划纲要[S]. 2016. https://www.gov.cn/zhengce/2016-10/25/content_5124174.htm.",
        "[5] 中华人民共和国国务院. 中国妇女发展纲要（2021—2030年）[S]. 2021.",
      ],
    },
  },
];
