...
const zhaominExtra = [
  ...
  // --- 第十二拍：大都宫闱 ---
  {
    ...
    question: {
      ...
      correctIndex: 2,
      explanation: '"是药三分毒"——这是中医最基本的用药安全理念。任何一种药物（包括中药、西药）都有治疗作用和不良反应。常见有毒中药：乌头类（乌头碱等二萜生物碱可作用于电压门控钠通道，诱发恶性心律失常）、马钱子（含士的宁→惊厥）、朱砂（含硫化汞→汞暴露风险）、雄黄（含砷→多器官毒性）。这些药物在现代临床中严格限制使用。安全用药原则：①经正规炮制减毒；②严格剂量控制；③合理配伍减毒；④在医师指导下使用。中成药如"六味地黄丸""加味逍遥丸"等常规剂量下安全，但也不宜长期滥用。',
      references: [
